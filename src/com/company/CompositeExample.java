...
import com.company.structure.composite.Developer;
import com.company.structure.composite.Employee;
import com.company.structure.composite.Lead;
import com.company.structure.composite.Manager;
...
public class CompositeExample {
    ...
    public static void main(String[] args) {
        ...
        manager.add(lead1);
        manager.add(lead2);
        manager.add(developer5); // manager can add object type Employee and Lead
